//This code works for Slave trigger mode
//there is one veto event for each TPC event
...
#ifdef random_data
string Time = "_sub_random_slave_Apr26PM";
#else
string Time = "_slave_Apr26PM";
#endif

#ifdef new_data
string dirname="/darkside/users/hqian/AmBe10Hz_Calibration/FermiDSTSlaveData/";
#else
string dirname="/darkside/users/hqian/AmBe10Hz_Calibration/DSTSlaveData/";
...
int main(int argc, char **argv){
  ...
  */
  ...
  TNtuple* tpc_neutron_ntuple = new TNtuple("tpc_neutron_ntuple","TPC Neutron Data","time:ene");
  ...
  */
  ...
  TNtuple* nv_ntuple = new TNtuple("nv_ntuple","Veto Data","total_s1:time:ene:height:mult");
  ...
  TNtuple* nv_gamma_full_ntuple = new TNtuple("nv_gamma_full_ntuple","Veto Gamma Data","total_s1:time:ene:height:mult");
  ...
  //  TNtuple* nv_gamma_full_ntuple = new TNtuple("nv_gamma_full_ntuple","Veto Gamma Data","total_s1:time:ene");
 ...
 TH1F* nv_gamma_prompt_gps_hist = new TH1F("nv_gamma_prompt_gps_hist","Veto Gamma Prompt Time;Time [ns]",100,middle_time,prompt_time);
  ...
  TH1F* nv_neutron_full_ene_hist = new TH1F("nv_neutron_full_ene_hist","Veto Neutron Full Energy;Energy [PE]",neutron_bins,0,neutron_coin_ene);
  ...
  TNtuple* nv_neutron_full_ntuple = new TNtuple("nv_neutron_full_ntuple","Veto Neutron Data","total_s1:time:ene:height:mult");
  ...
  TH1F* nv_neutron_second_gps_hist = new TH1F("nv_neutron_second_gps_hist","Veto Neutron Second Time;Time [ns]",100,prompt_time,first_time);
  TH1F* nv_neutron_second_ene_hist = new TH1F("nv_neutron_second_ene_hist","Veto Neutron Second Energy;Energy [PE]",100,0,neutron_coin_ene);
  TH1F* nv_neutron_second_small_ene_hist = new TH1F("nv_neutron_second_small_ene_hist","Veto Neutron Second Energy(small range);Energy [PE]",fail_bins,0,fail_ene);
  TH2F* nv_neutron_second_gps_ene_hist = new TH2F("nv_neutron_second_gps_ene_hist","Veto Neutron Second Time Vs Energy;Time [ns];Energy[PE]",100,prompt_time,first_time,100,0,neutron_coin_ene);
  //  TNtuple* nv_neutron_second_ntuple = new TNtuple("nv_neutron_second_ntuple","Veto Neutron Second Data","total_s1:time:ene");
  TNtuple* nv_neutron_second_ntuple = new TNtuple("nv_neutron_second_ntuple","Veto Neutron Second Data","time:ene:height:mult");
  ...
  TH1F* nv_neutron_delay_gps_hist = new TH1F("nv_neutron_delay_gps_hist","Veto Neutron Delay Time;Time [ns]",neutron_bins,delay_time,late_time);
  ...
  TH2F* nv_neutron_delay_gps_ene_hist = new TH2F("nv_neutron_delay_gps_ene_hist","Veto Neutron Delay Time Vs Energy;Time [ns];Energy[PE]",neutron_bins,delay_time,late_time,neutron_bins,0,neutron_coin_ene);
  ...
  TH1F* nv_neutron_first_alpha_gps_hist = new TH1F("nv_neutron_first_alpha_gps_hist","Veto Neutron First Alpha Only Time;Time [ns]",500,first_time,window2end);//delay_time);
  TH1F* nv_neutron_first_r_gps_hist = new TH1F("nv_neutron_first_r_gps_hist","Veto Neutron First Alpha+gamma Time;Time [ns]",500,first_time,window2end);//delay_time);  //300       
  ...
  TH1F* nv_neutron_window1_first_gps_hist = new TH1F("nv_neutron_window1_first_gps_hist","Veto Neutron Window1 First Time;Time [ns]",neutron_first_bins,window1start,window1end);
  TH1F* nv_neutron_window1_first_ene_hist = new TH1F("nv_neutron_window1_first_ene_hist","Veto Neutron Window1 First Energy;Energy [PE]",neutron_first_bins,0,neutron_coin_ene);
  ...
  TH2F* nv_neutron_window1_first_gps_ene_hist = new TH2F("nv_neutron_window1_first_gps_ene_hist","Veto Neutron Window1 First Time Vs Energy;Time [ns];Energy[PE]",neutron_first_bins,window1start,window1end,neutron_first_bins,0,neutron_coin_ene);
  TH1F* nv_neutron_window1_first_alpha_gps_hist = new TH1F("nv_neutron_window1_first_alpha_gps_hist","Veto Neutron window1 First Alpha Only Time;Time [ns]",neutron_first_bins,window1start,window1end);
  TH1F* nv_neutron_window1_first_r_gps_hist = new TH1F("nv_neutron_window1_first_r_gps_hist","Veto Neutron window1 First Alpha+gamma Time;Time [ns]",neutron_first_bins,window1start,window1end);
  ...
  TH1F* nv_neutron_window2_first_gps_hist = new TH1F("nv_neutron_window2_first_gps_hist","Veto Neutron Window2 First Time;Time [ns]",neutron_first_bins,window2start,window2end);
  TH1F* nv_neutron_window2_first_ene_hist = new TH1F("nv_neutron_window2_first_ene_hist","Veto Neutron Window2 First Energy;Energy [PE]",neutron_first_bins,0,neutron_coin_ene);
  ...
  TH2F* nv_neutron_window2_first_gps_ene_hist = new TH2F("nv_neutron_window2_first_gps_ene_hist","Veto Neutron Window2 First Time Vs Energy;Time [ns];Energy[PE]",neutron_first_bins,window2start,window2end,neutron_first_bins,0,neutron_coin_ene);
  //  TNtuple* nv_neutron_window_first_ntuple = new TNtuple("nv_neutron_window_first_ntuple","Veto Neutron Window_First Data","total_s1:time:ene");
  TH1F* nv_neutron_window2_first_alpha_gps_hist = new TH1F("nv_neutron_window2_first_alpha_gps_hist","Veto Neutron window2 First Alpha Only Time;Time [ns]",neutron_first_bins,window2start,window2end);
  TH1F* nv_neutron_window2_first_r_gps_hist = new TH1F("nv_neutron_window2_first_r_gps_hist","Veto Neutron window2 First Alpha+gamma Time;Time [ns]",neutron_first_bins,window2start,window2end);
  ...
  for(int i=0; i<Entries; i++)
      ...
      if(tpc_event_type==0)  //select gamma
	{
	  ...
	  tpc_gamma_ntuple->Fill(tpc_timestamp,tpc_total_s1);
	}
      else if(tpc_event_type==1)  //select neutron
	{
	  ...
	  tpc_neutron_ntuple->Fill(tpc_timestamp,tpc_total_s1);
	  tpc_neutron++;
	}
      ...
      int n1=0;
      int n2=0;
      bool nbigpulse_tag = false;
      bool nafterpulse_tag=false;
      bool nafterpulse_window1_tag=false;
      bool nafterpulse_window2_tag=false;
	...
	{ 
	  if(od_cluster_charge->at(ncluster)>0 && od_wt_charge<500) 
	    {
	  //*********************All OD cluster******************************************************************
	      double gps_all_diff_temp = gps_diff + od_cluster_dtprompt->at(ncluster)*1.e+3;  //ns	  
	      ...
	      nv_all_ntuple->Fill(tpc_total_s1,gps_all_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
		  ...
		  if(gps_all_gamma_diff_temp>prompt_time && gps_all_gamma_diff_temp<delay_time)
		    {
		      ...
		      nv_all_gamma_coincidence_ntuple->Fill(tpc_total_s1,gps_all_gamma_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
		    }		    
		}
	      if(tpc_event_type==1)
		{
		  ...
		  if(gps_all_neutron_diff_temp>prompt_time && gps_all_neutron_diff_temp<delay_time)
		    {
		      ...
		      nv_all_neutron_coincidence_ntuple->Fill(tpc_total_s1,gps_all_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
		    }		    
		} //end of all clusters
	 ...
	 //*********************Failing MultiCut cluster******************************************************************
		...
		{
		  double gps_fail_diff_temp = gps_diff + od_cluster_dtprompt->at(ncluster)*1.e+3;  //ns	  
		  ...
		  nv_fail_ntuple->Fill(tpc_total_s1,gps_fail_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
		  ...
		  if(tpc_event_type==0)
		      ...
		      if(gps_fail_gamma_diff_temp>prompt_time && gps_fail_gamma_diff_temp<delay_time)
			{
			  ...
			  nv_fail_gamma_coincidence_ntuple->Fill(tpc_total_s1,gps_fail_gamma_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster)); 
			}		    
		    }
		  if(tpc_event_type==1)
		    {
		      ...
		      if(gps_fail_neutron_diff_temp>prompt_time && gps_fail_neutron_diff_temp<delay_time)
			{
			  ...
			  nv_fail_neutron_coincidence_ntuple->Fill(tpc_total_s1,gps_fail_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));	    
			}		    
		    }
	  ...
	  //*********************Passing MultiCut cluster******************************************************************
		...
		// double gps_diff_temp = gps_diff + od_cluster_start->at(ncluster)*1.e+3;  //ns	  
		  double gps_diff_temp = gps_diff + od_cluster_dtprompt->at(ncluster)*1.e+3;  //ns	  
		  ...
		  nv_ntuple->Fill(tpc_total_s1,gps_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
		  ...
		  if(gps_diff_temp<end_time && gps_diff_temp>late_time)
		    {
		      ...
		      nv_late_ntuple->Fill(tpc_total_s1,gps_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));		     
		    }	      
		  if(tpc_event_type==0)//gamma
		    {
		      ...
		      nv_gamma_full_ntuple->Fill(tpc_total_s1,gps_gamma_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
		  ...
		  if(tpc_event_type==1)//neutron
		    {
		      ...
		      nv_neutron_full_ntuple->Fill(tpc_total_s1,gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
		      ...
		      if(gps_neutron_diff_temp>middle_time && gps_neutron_diff_temp<prompt_time)
			{
		      ...
		      if(gps_neutron_diff_temp>prompt_time && gps_neutron_diff_temp<first_time && od_cluster_charge->at(ncluster)>afterpulse_cut)
			{
			  nafterpulse_tag=true;
			  nv_neutron_second_gps_hist->Fill(gps_neutron_diff_temp);
			  nv_neutron_second_ene_hist->Fill(od_cluster_charge->at(ncluster));
			  nv_neutron_second_small_ene_hist->Fill(od_cluster_charge->at(ncluster));
			  nv_neutron_second_gps_ene_hist->Fill(gps_neutron_diff_temp,od_cluster_charge->at(ncluster));
			  nv_neutron_second_ntuple->Fill(gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
			}
		      if(gps_neutron_diff_temp<window1start && gps_neutron_diff_temp>first_time && od_cluster_charge->at(ncluster)>afterpulse_cut)
			{
			  nafterpulse_window1_tag=true;
			}
		      if(gps_neutron_diff_temp<window2start && gps_neutron_diff_temp>window1start && od_cluster_charge->at(ncluster)>afterpulse_cut)
			{
			  nafterpulse_window2_tag=true;
			}		      		      
...
#else
      if(lsv_gamma_gps.size())	  
#endif
	{ 
	  for(int ncluster=0; ncluster<od_nclusters; ncluster++)
	    { 	 
	      if(od_cluster_charge->at(ncluster)>0 && tpc_event_type==0 && od_wt_charge<500 && od_cluster_pass_multcut->at(ncluster)==1)
		{
		  double gps_gamma_diff_temp =  od_cluster_dtprompt->at(ncluster)*1.e+3 ;//- lsv_gamma_gps.front();	 
		  ...
		  if(gps_gamma_diff_temp>middle_time && gps_gamma_diff_temp<end_time)
		    {  
		      ...
		      nv_gamma_coincidence_ntuple->Fill(tpc_total_s1,gps_gamma_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));     
		    }		    
		  if(gps_gamma_diff_temp>middle_time && gps_gamma_diff_temp<prompt_time)
		    {
		      ...
		      nv_gamma_prompt_ntuple->Fill(tpc_total_s1,gps_gamma_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));		
		    }
		  if(gps_gamma_diff_temp>delay_time && gps_gamma_diff_temp<late_time)
		    {
		      ...
		      nv_gamma_delay_ntuple->Fill(tpc_total_s1,gps_gamma_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));		
		    }
		  if(gps_gamma_diff_temp>after_time && gps_gamma_diff_temp<delay_time)
		    {
		      ...
		      nv_gamma_after_ntuple->Fill(tpc_total_s1,gps_gamma_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));	 
		    }
#ifdef old_method
		  ...
		  if(gps_gamma_diff_temp>first_time && gps_gamma_diff_temp<delay_time && !afterpulse_tag)
		      ...
		      if(g==1)
			{
			  ...
			  nv_gamma_first_ntuple->Fill(tpc_total_s1,gps_gamma_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));	       
			  ...
			  if(od_cluster_charge->at(ncluster)>243 && od_cluster_charge->at(ncluster)<246)
			    cout<<"run ID"<<runID<<"od event"<<od_eventID<<endl;
			}
		    }
#ifdef old_method
		  ...
		  if(gps_gamma_diff_temp>late_time && gps_gamma_diff_temp<end_time)
			...
			nv_gamma_late_ntuple->Fill(tpc_total_s1,gps_gamma_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));	      
		      }
		    }
		}//end of multicuts
	    } //end of loop
...
#else
      if(lsv_neutron_gps.size())	  
#endif
	{ 
	  for(int ncluster=0; ncluster<od_nclusters; ncluster++)
	    { 	 
	      if(od_cluster_charge->at(ncluster)>0 && tpc_event_type==1 && od_wt_charge<500 && od_cluster_pass_multcut->at(ncluster)==1)
		{
		  double gps_neutron_diff_temp =  od_cluster_dtprompt->at(ncluster)*1.e+3;// - lsv_neutron_gps.front();      
		  if(gps_neutron_diff_temp>middle_time && gps_neutron_diff_temp<end_time)
		    {
		      ...
		      nv_neutron_coincidence_ntuple->Fill(tpc_total_s1,gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));	 
		    }		    
		  if(gps_neutron_diff_temp>middle_time && gps_neutron_diff_temp<prompt_time)
		    {
		      ...
		      nv_neutron_prompt_ntuple->Fill(tpc_total_s1,gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));	    
		    }
		  if(gps_neutron_diff_temp>delay_time && gps_neutron_diff_temp<late_time)
		    {
		      ...
		      nv_neutron_delay_ntuple->Fill(tpc_total_s1,gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));	    
		    }
		  if(gps_neutron_diff_temp>after_time && gps_neutron_diff_temp<delay_time)
		    {
		      ...
		      nv_neutron_after_ntuple->Fill(tpc_total_s1,gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));	    
		    }
#ifdef old_method
		  if(gps_neutron_diff_temp>first_time && gps_neutron_diff_temp<delay_time)
#else
		  if(gps_neutron_diff_temp>first_time && gps_neutron_diff_temp<delay_time && !nafterpulse_tag)
#endif
		    { ++n;
		      if(n==1)
			{
			  ...
			  nv_neutron_first_ntuple->Fill(tpc_total_s1,gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));   
			  if(od_cluster_charge->at(ncluster)>pos3 && od_cluster_charge->at(ncluster)<pos4)
			    { cout<<"1"<<endl;
...
#else
		  if(gps_neutron_diff_temp>window1start && gps_neutron_diff_temp<window1end && !nafterpulse_window1_tag)
#endif		 
		    { ++n1;
		      if(n1==1)
			{
			  nv_neutron_window1_first_gps_hist->Fill(gps_neutron_diff_temp);
			  nv_neutron_window1_first_ene_hist->Fill(od_cluster_charge->at(ncluster));
			  nv_neutron_window1_first_small_ene_hist->Fill(od_cluster_charge->at(ncluster));
			  nv_neutron_window1_first_gps_ene_hist->Fill(gps_neutron_diff_temp,od_cluster_charge->at(ncluster));
			  nv_neutron_window1_first_ntuple->Fill(gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
			  if(od_cluster_charge->at(ncluster)>pos3 && od_cluster_charge->at(ncluster)<pos4)
...
#else		 
		  if(gps_neutron_diff_temp>window2start && gps_neutron_diff_temp<window2end && !nafterpulse_window2_tag)
#endif
		    { ++n2;
		      if(n2==1)
			{ cout<<"4"<<endl;
			  nv_neutron_window2_first_gps_hist->Fill(gps_neutron_diff_temp);
			  nv_neutron_window2_first_ene_hist->Fill(od_cluster_charge->at(ncluster));
			  nv_neutron_window2_first_small_ene_hist->Fill(od_cluster_charge->at(ncluster));
			  nv_neutron_window2_first_gps_ene_hist->Fill(gps_neutron_diff_temp,od_cluster_charge->at(ncluster));
			  nv_neutron_window2_first_ntuple->Fill(gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));
			  if(od_cluster_charge->at(ncluster)>pos3 && od_cluster_charge->at(ncluster)<pos4)
		  ...
		  if(gps_neutron_diff_temp>late_time && gps_neutron_diff_temp<end_time)
			...
			nv_neutron_late_ntuple->Fill(tpc_total_s1,gps_neutron_diff_temp,od_cluster_charge->at(ncluster),od_cluster_height->at(ncluster),od_cluster_multiplicity->at(ncluster));	      
		      }
		    }
		} //end of multicuts
	    }//end of loop
  ...
  //  double height = 0.00145;
  double height = nv_neutron_first_small_ene_hist->GetMaximum();
...
#ifdef new_data
  string outdirname="/darkside/users/hqian/AmBe10Hz_Calibration/FermiDSTSlaveResults/";
  string plotdir="/darkside/users/hqian/AmBe10Hz_Calibration/FermiDSTSlaveResults/Plots/";
#else
  string outdirname="/darkside/users/hqian/AmBe10Hz_Calibration/";
  string plotdir="/darkside/users/hqian/AmBe10Hz_Calibration/Plots/";
#endif
  string ext = "png";

#ifdef random_data
  string bgfile = outdirname+"AmBe10Hz_1107211073_slave_Mar26PM.root";
  ...
  TH1F *bg_neutron_prompt_small_ene_hist = (TH1F*) bg->Get("nv_neutron_prompt_small_ene_hist");
  TH1F *bg_neutron_after_small_ene_hist = (TH1F*) bg->Get("nv_neutron_after_small_ene_hist");
  TH1F *bg_neutron_first_small_ene_hist = (TH1F*) bg->Get("nv_neutron_first_small_ene_hist");
  TH1F *bg_neutron_delay_small_ene_hist = (TH1F*) bg->Get("nv_neutron_delay_small_ene_hist");
  TH1F *bg_neutron_late_small_ene_hist = (TH1F*) bg->Get("nv_neutron_late_small_ene_hist");
  TH1F *bg_neutron_coincidence_small_ene_hist = (TH1F*) bg->Get("nv_neutron_coincidence_small_ene_hist");
  TH1F *bg_neutron_window1_first_small_ene_hist = (TH1F*) bg->Get("nv_neutron_window1_first_small_ene_hist");
  TH1F *bg_neutron_window2_first_small_ene_hist = (TH1F*) bg->Get("nv_neutron_window2_first_small_ene_hist");

  bg_neutron_prompt_small_ene_hist->SetLineColor(linecolor.at(3));
  bg_neutron_after_small_ene_hist->SetLineColor(linecolor.at(3));
  bg_neutron_first_small_ene_hist->SetLineColor(linecolor.at(3));
  bg_neutron_delay_small_ene_hist->SetLineColor(linecolor.at(3));
  bg_neutron_late_small_ene_hist->SetLineColor(linecolor.at(3));
  bg_neutron_coincidence_small_ene_hist->SetLineColor(linecolor.at(3));
  bg_neutron_window1_first_small_ene_hist->SetLineColor(linecolor.at(3));
  bg_neutron_window2_first_small_ene_hist->SetLineColor(linecolor.at(3));
#endif
...
#ifdef random_data
  nv_neutron_delay_small_ene_subtracted_hist->Add(nv_neutron_delay_small_ene_hist,bg_neutron_delay_small_ene_hist,1,-1);
#else
...
#ifdef random_data
  bg_neutron_delay_small_ene_hist->Draw("same");
#else
...
#ifdef random_data
  nv_neutron_coincidence_small_ene_subtracted_hist->Add(nv_neutron_coincidence_small_ene_hist,bg_neutron_coincidence_small_ene_hist,1,-1);
#else
...
#ifdef random_data
  bg_neutron_coincidence_small_ene_hist->Draw("same");
#else
  nv_neutron_late_small_ene_hist->Draw("same");
#endif
  box1->Draw();
...
#ifdef random_data
  nv_neutron_after_small_ene_subtracted_hist->Add(nv_neutron_after_small_ene_hist,bg_neutron_after_small_ene_hist,1,-1);
#else
...
#ifdef random_data
  bg_neutron_after_small_ene_hist->Draw("same");
#else
  nv_neutron_late_small_ene_hist->Draw("same");
#endif
  box1->Draw();
...
#ifdef random_data
  nv_neutron_first_small_ene_subtracted_hist->Add(nv_neutron_first_small_ene_hist,bg_neutron_first_small_ene_hist,1,-1);
#else
...
#ifdef random_data
  bg_neutron_first_small_ene_hist->Draw("same");
#else
  nv_neutron_late_small_ene_hist->Draw("same");
#endif
  box1->Draw();
  ...
  double nbr3 = nv_neutron_first_small_ene_subtracted_hist->Integral(nv_neutron_first_small_ene_subtracted_hist->FindBin(pos3),nv_neutron_first_small_ene_subtracted_hist->FindBin(pos4));
  double nbr4 = nv_neutron_first_small_ene_subtracted_hist->Integral(nv_neutron_first_small_ene_subtracted_hist->FindBin(pos3),nv_neutron_first_small_ene_subtracted_hist->FindBin(pos2));
  cout<<"Neutron first "<<1.*nbr3/nbr4<<endl;
...
#ifdef random_data
  nv_neutron_prompt_small_ene_subtracted_hist->Add(nv_neutron_prompt_small_ene_hist,bg_neutron_prompt_small_ene_hist,1,-1);
#else
...
#ifdef random_data
  bg_neutron_prompt_small_ene_hist->Draw("same");
#else
  nv_neutron_late_small_ene_hist->Draw("same");
#endif
  box1->Draw();
  ...
  #ifdef random_data
  nv_neutron_window1_first_small_ene_subtracted_hist->Add(nv_neutron_window1_first_small_ene_hist,bg_neutron_window1_first_small_ene_hist,1,-1);
  #else
  ...
  #ifdef random_data
  bg_neutron_window1_first_small_ene_hist->Draw("same");
  #else
  nv_neutron_late_small_ene_hist->Draw("same");
  #endif
  box1->Draw();
  ...
  #ifdef random_data
  nv_neutron_window2_first_small_ene_subtracted_hist->Add(nv_neutron_window2_first_small_ene_hist,bg_neutron_window2_first_small_ene_hist,1,-1);
  #else
  ...
  #ifdef random_data
  bg_neutron_window2_first_small_ene_hist->Draw("same");
  #else
  nv_neutron_late_small_ene_hist->Draw("same");
  #endif
  box1->Draw();
  ...
  */
  ...
  nv_neutron_second_gps_hist->Write();
  nv_neutron_second_ene_hist->Write();
  nv_neutron_second_small_ene_hist->Write();
  nv_neutron_second_gps_ene_hist->Write();
  nv_neutron_second_ntuple->Write();
