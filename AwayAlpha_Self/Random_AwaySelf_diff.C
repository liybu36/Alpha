...
//void main()
{
  ...
  TFile* attach = new TFile("/darkside/users/hqian/AmBe10Hz_Calibration/AwaySelfTriggerResults/AmBe10Hz_1107011071_away_Feb11PM.root");
