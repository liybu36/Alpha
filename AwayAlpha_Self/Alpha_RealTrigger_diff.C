...
#define low_PPO
#ifdef low_PPO
  //*******Before Adding PPO, 0.6g/L PPO**************
  TFile* attach = new TFile("/darkside/users/hqian/AmBe10Hz_Calibration/AmBe10Hz_1113111148_Feb11PM.root");
  TFile* away = new TFile("/darkside/users/hqian/AmBe10Hz_Calibration/AwaySelfTriggerResults/AmBe10Hz_1115511188_away_Feb11PM.root");

  //******After Adding PPO, 1.5g/L PPO***************
  //  TFile* attach = new TFile("/darkside/users/hqian/AmBe10Hz_Calibration/AmBe10Hz_1097411009_Feb11PM.root");
  // TFile* away = new TFile("/darkside/users/hqian/AmBe10Hz_Calibration/AwaySelfTriggerResults/AmBe10Hz_1103911096_away_Feb11PM.root");
