...
#define random_data
#ifdef random_data
string Time = "_sub_random_away_Mar22PM";
#else
string Time = "_away_Mar22PM";
#endif
	 ...
	 //*********************Failing MultiCut cluster******************************************************************
	  ...
	  //*********************Passing MultiCut cluster******************************************************************
		...
		{	
		  ...
		  if(gps_gamma_diff_temp>prompt_time && gps_gamma_diff_temp<first_time)
		    {
		      afterpulse_tag=true;
		    }
...
#ifdef random_data
  string bgfile = outdirname+"AmBe10Hz_1107011071_away_Feb19PM.root"; 
