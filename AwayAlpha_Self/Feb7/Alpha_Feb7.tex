...
\begin{exampleblock}{Cuts}
	...
	%\item remove after pulses: od$\_$cluster$\_$charge $>$ 500PE
...
\begin{figure}
%\includegraphics[height= 4cm, width=\textwidth]{nv_neutron_after_small_ene_subtracted_Jan26PM.png}
...
%\item the branch ratio of \textcolor{red}{peak 1} to total increases to \textcolor{red}{14.43$\%$}
...
\item \textcolor{blue}{blue} Lines in left plot is the accidental background 
\item the plots on the right has subtracted the accidental background 
%\item the branch ratio of \textcolor{red}{peak 1} to total becomes to \textcolor{red}{5.81$\%$}, which sort of matches with 6.4$\%$
\item the peak around 20PE comes from $\alpha$(1775keV) only channel (\textcolor{red}{peak 1})
\item the peak around 250PE comes from $\alpha$(1471keV)+$\gamma$(478keV) channel (\textcolor{green}{peak 2})
...
%\includegraphics[height= 6cm, width=.8\textwidth]{nv_gamma_alpha_capture_time_Feb7PM.png}
\end{figure}
\end{frame}
...
\end{itemize}
\begin{figure}
\includegraphics[height= 4cm, width=.5\textwidth]{nv_gamma_full_ene_away_Feb7PM.png}
\includegraphics[height= 4cm, width=.5\textwidth]{nv_gamma_full_small_ene_away_Feb7PM.png}
\caption{Left: Energy spectrum in veto from real data. Right: Small Range Energy spectrum in veto from real data.}
\end{figure}
\end{frame}
...
%\includegraphics[height= 6cm, width=.8\textwidth]{nv_gamma_alpha_capture_time_away_Feb7PM.png}
\end{figure}
\end{frame}
...
%\begin{figure}
%\includegraphics[height= 4cm, width=\textwidth]{nv_neutron_after_small_ene_subtracted_Jan26PM.png}
%\includegraphics[height= 4cm, width=\textwidth]{nv_gamma_delay_small_ene_subtracted_Feb7PM.png}
%\end{figure}
%\begin{itemize}
%\setbeamertemplate{itemize items}[bullet]
%\item trigger on the gamma in TPC, 0 $<$od$\_$cluster$\_$dtprompt $<$ 60us
%\item skip in 0 $<$od$\_$cluster$\_$dtprompt $<$ 20us, which od$\_$cluster$\_$charge $>$ 500PE
%\item  select od$\_$cluster$\_$charge $>$ 0
%\item \textcolor{blue}{blue} Lines in left plot is the accidental background 
%\item the plots on the right has subtracted the accidental background 
%\item the peak around 20PE comes from $\alpha$(1775keV) only channel (\textcolor{red}{peak 1})
%\item the peak around 250PE comes from $\alpha$(1471keV)+$\gamma$(478keV) channel (\textcolor{green}{peak 2})
%\item the branch ratio of \textcolor{red}{peak 1} to total increases to \textcolor{red}{20.1$\%$}, which is 6.4$\%$ Initially 
%\end{itemize}
%\end{frame}
...
%\item the plot on the right side is smeared by response function
%\item the peak around 50keVee comes from $\alpha$(1775keV) only channel (\textcolor{red}{peak 1})
%\item the peak around 420keVee comes from $\alpha$(1471keV)+$\gamma$(478keV) channel (\textcolor{green}{peak 2})
...
%\begin{frame}{Select Neutron in TPC}
%\begin{itemize}
%\setbeamertemplate{itemize items}[bullet]
%\item goal: see neutrons that scatters in TPC before going to veto
%\item event signature:
%	\begin{itemize}
%	\setbeamertemplate{itemize items}[default]
...
%\begin{frame}{Energy Spectrum in Veto}
%\begin{itemize}
%\setbeamertemplate{itemize items}[bullet]
%\item select the neutron event inside the TPC 
%\item high energy gamma scatters and deposits energy in TPC
...
%\end{itemize}
%\begin{figure}
%\includegraphics[height= 4cm, width=.5\textwidth]{nv_neutron_full_ene_Jan26PM.png}
%\includegraphics[height= 4cm, width=.5\textwidth]{nv_neutron_full_small_ene_Jan26PM.png}
%\caption{Left: Energy spectrum in veto from real data. Right: Small Range Energy spectrum in veto from real data.}
%\end{figure}
%\end{frame}
...
%\begin{frame}{Energy of Veto Clusters}
%\begin{figure}
%\includegraphics[height= 4cm, width=\textwidth]{nv_neutron_delay_small_ene_subtracted_Jan26PM.png}
%\includegraphics[height= 4cm, width=\textwidth]{nv_neutron_after_small_ene_subtracted_Jan26PM.png}
%\end{figure}
%\begin{itemize}
%\setbeamertemplate{itemize items}[bullet]
%\item trigger on the neutron in TPC, 0 $<$od$\_$cluster$\_$dtprompt $<$ 60us
%\item skip in 0 $<$od$\_$cluster$\_$dtprompt $<$ 20us, which od$\_$cluster$\_$charge $>$ 500PE
%\item  select od$\_$cluster$\_$charge $>$ 0
%\item \textcolor{brown}{brown} Lines in left plot is the accidental background 
%\item the plots on the right has subtracted the accidental background 
%\item the peak around 20PE comes from $\alpha$(1775keV) only channel (\textcolor{red}{peak 1})
%\item the peak around 250PE comes from $\alpha$(1471keV)+$\gamma$(478keV) channel (\textcolor{green}{peak 2})
%\item the branch ratio of \textcolor{red}{peak 1} to total increases to \textcolor{red}{29.6$\%$}, which is 6.4$\%$ Initially 
%\end{itemize}
%\end{frame}

%\begin{frame}{First Cluster After Prompt}
%\begin{figure}
%\includegraphics[height= 4cm, width=\textwidth]{nv_neutron_after_small_ene_subtracted_Jan26PM.png}
%\includegraphics[height= 4cm, width=\textwidth]{nv_neutron_first_small_ene_subtracted_Jan26PM.png}
%\end{figure}
%\begin{itemize}
%\setbeamertemplate{itemize items}[bullet]
%\item trigger on neutron in TPC
%\item skip in 0 $<$od$\_$cluster$\_$dtprompt $<$ 20us, which od$\_$cluster$\_$charge $>$ 500PE
%\item  select od$\_$cluster$\_$charge $>$ 0
%\item the first cluster after 20us
%\item \textcolor{brown}{brown} Lines in left plot is the accidental background 
%\item the plots on the right has subtracted the accidental background 
%\item the branch ratio of \textcolor{red}{peak 1} to total becomes to \textcolor{red}{7.76$\%$},which sort of matches with 6.4$\%$
%\item the peak around 20PE comes from $\alpha$(1775keV) only channel (\textcolor{red}{peak 1})
%\item the peak around 250PE comes from $\alpha$(1471keV)+$\gamma$(478keV) channel (\textcolor{green}{peak 2})
...
%\begin{frame}{Late Clusters in Veto}
%\begin{figure}
%\includegraphics[height= 4cm, width=\textwidth]{nv_neutron_after_small_ene_subtracted_Jan26PM.png}
%\includegraphics[height= 4cm, width=\textwidth]{nv_neutron_after_small_ene_subtracted_Jan26PM.png}
%\end{figure}
...
%\item \textcolor{brown}{brown} Lines in left plot is the accidental background 
%\item the plots on the right has subtracted the accidental background 
%\item the branch ratio of \textcolor{red}{peak 1} to total increases to \textcolor{red}{19.29$\%$}
%\item the peak around 20PE comes from $\alpha$(1775keV) only channel (\textcolor{red}{peak 1})
%\item the peak around 250PE comes from $\alpha$(1471keV)+$\gamma$(478keV) channel (\textcolor{green}{peak 2})
%\item the branch ratio of \textcolor{red}{peak 1} to total increases to \textcolor{red}{9.3$\%$}, which is 6.4$\%$ Initially 
%\end{itemize}
