...
//void main()
{
...
#ifdef new_data
  TFile* attach = new TFile("/darkside/users/hqian/AmBe10Hz_Calibration/FermiDSTAwayResults/AmBe10Hz_1103911096_sub_random_away_Mar28PM.root");
  TFile* away = new TFile("/darkside/users/hqian/AmBe10Hz_Calibration/FermiDSTAwayResults/AmBe10Hz_1115511188_sub_random_away_Mar28PM.root");
#else
  TFile* attach = new TFile("/darkside/users/hqian/AmBe10Hz_Calibration/AwaySelfTriggerResults/AmBe10Hz_1103911096_sub_random_away_Mar28PM.root");
  TFile* away = new TFile("/darkside/users/hqian/AmBe10Hz_Calibration/AwaySelfTriggerResults/AmBe10Hz_1115511188_sub_random_away_Mar28PM.root");
#endif
  ...
  string entryname[2] = {"away from cryotat,0.6g/L PPO","away from cryostat,1.5g/L PPO"}; 
...
#ifdef new_data
  string dirname="/darkside/users/hqian/AmBe10Hz_Calibration/FermiDSTAwayResults/";
  ...
  string output1=dirname+"AwaydiffPPO"+Time+".root"; 
